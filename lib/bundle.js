...
class View {
  ...
  setupBoard() {
    ...
    // introductory box
    const $intro = $("<div><h1>INSTRUCTIONS</h1><p>Create words out of the letters on the screen. Use the letters before they reach the edge of the green bar. Longer words earn you more points. Good luck!</p></div>");
    $intro.attr('id','intro');
