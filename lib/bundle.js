...
class View {
  ...
  setupBoard() {
    ...
    // introductory box
    const $intro = $("<div><h1>INSTRUCTIONS</h1><p>Create words out of the letters on the screen. Use the letters before they hit the red bar. Words are 3 letters minimum, and longer words earn you more points. The higher your score, the faster the tiles move. Good luck!</p></div>");
    $intro.attr('id','intro');
