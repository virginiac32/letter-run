...
class View {
  ...
  setupBoard() {
    ...
    // introductory box
    const $intro = $("<div><h1>INSTRUCTIONS</h1><p>Create words out of the letter tiles on the screen. Use the letters before they reach the left edge! Longer words earn you more points.</p></div>");
    $intro.attr('id','intro');
